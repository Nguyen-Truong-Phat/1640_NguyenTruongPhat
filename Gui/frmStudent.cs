...
namespace Gui
{
    public partial class frmStudent : Form
    {
        ...
        // Biến lưu đường dẫn ảnh tạm thời khi người dùng chọn file mới
        ...
        private void frmStudent_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                // 1. Load danh sách khoa vào ComboBox
                var listFacultys = facultyService.GetAll();
                FillFalcultyCombobox(listFacultys);

                // 2. Load danh sách sinh viên vào DataGridView
        ...
        // Sự kiện Click vào dòng trong GridView
        private void dgvStudent_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                // Hiển thị Avatar
                // Cần query lại DB hoặc lưu Avatar trong Tag của Row để lấy tên file
                var studentID = txtStudentID.Text;
                var student = studentService.FindById(studentID); // [cite: 249-252]
                if (student != null)
                {
